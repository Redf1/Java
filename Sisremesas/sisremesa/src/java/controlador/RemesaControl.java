...
public class RemesaControl implements Serializable {
    ...
    public RemesaControl() {
        // para que funcionen los combos
        remesa = new Remesa();  
    }

    public List<Remesa> getListaRemesas() {
        RemesaDao rd = new RemesaDao();
        listaRemesas = rd.listarRemesas();
        return listaRemesas;
    }
    ...
    public List<SelectItem> getListaPersonasEnvian() {
        this.listaPersonasEnvian = new ArrayList<SelectItem>();
        PersonaEnviaDao pd = new PersonaEnviaDao();
        List<PersonaEnvia> personasEnvian = pd.listarPersonasEnvia();
    ...
    public List<SelectItem> getListaPersonasReciben() {
        this.listaPersonasReciben = new ArrayList<SelectItem>();
        PersonaRecibeDao pr = new PersonaRecibeDao();
        List<PersonaRecibe> personasReciben = pr.listarPersonasRecibe();
        listaPersonasReciben.clear();
